...
public int find_tvalue(int input1, int input2, int input3) {
	...
	if(input2%2==0 && prime(input2)) {
		t=input1*input1*(primeSum(input2));
	}else if(input2%2!=0&&prime(input2)){
		t=input2*input2*(primeSum(input3));
	}else if(input2%2==0) {
		t=input3*input3*(primeSum(input2+input3));
	}else {
		t=primeSum(input1+input2+input3);
	}
	if(prime(t))
		ret=input3+t;
	else
